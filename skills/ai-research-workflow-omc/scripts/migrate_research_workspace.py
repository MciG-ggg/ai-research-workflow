#!/usr/bin/env python3
"""Safely migrate legacy .omc/ai-research workspaces to current guardrails.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Migrate legacy .omc/ai-research control-plane workspaces safely.")
