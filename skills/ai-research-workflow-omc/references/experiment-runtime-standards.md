...
When an experiment requires multiple seeds and each seed is independent, split seeds across native subagents or OMC `/oh-my-claudecode:team` lanes when parallelism is safe.
