...
def main() -> int:
    parser = argparse.ArgumentParser(description="Update .omx/ai-research/<slug>/STATE.json.")
    ...
    state_path = args.project_root.resolve() / ".omx" / "ai-research" / args.slug / "STATE.json"
