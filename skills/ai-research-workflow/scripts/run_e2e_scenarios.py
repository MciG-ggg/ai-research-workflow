...
def add_concrete_evidence(project: Path, slug: str) -> None:
    workstream = project / ".omx" / "ai-research" / slug
    ...
    replace_first(
        ...
        "| run-001 | complete | `bash scripts/run_demo.sh` | seed=1/cpu | `.omx/ai-research/demo-lane/runs/run-001` | `.omx/ai-research/demo-lane/runs/run-001/log.txt` | `.omx/ai-research/demo-lane/runs/run-001/metrics.json` | `.omx/ai-research/demo-lane/runs/run-001/summary.md` | none | control-plane fixture |",
    )
    ...
    replace_first(
        ...
        "| C1 | Demo method improves the metric | inconclusive | `.omx/ai-research/demo-lane/runs/run-001/summary.md` | fixture scope | say inconclusive in fixture | say proven | 2026-05-09 |",
    )
    replace_first(
        workstream / "SCRIPT_REGISTRY.md",
        "| TODO | TODO | TODO | TODO | TODO | TODO |",
        "| `bash .omx/ai-research/demo-lane/scripts/run_demo.sh` | fixture command only | none | `.omx/ai-research/demo-lane/runs/run-001/summary.md` | dry-run validated | 2026-05-09 |",
    )
...
def scenario_main_workspace(tmp: Path) -> None:
    ...
    answer = py(
        ...
        "--evidence",
        ".omx/ai-research/demo-lane/runs/run-001/summary.md",
    )
...
def scenario_migration(tmp: Path) -> None:
    legacy = tmp / "legacy"
    lane = legacy / ".omx" / "ai-research" / "old-lane"
    ...
    assert (legacy / ".omx" / "ai-research" / "RESEARCH.md").is_file()
