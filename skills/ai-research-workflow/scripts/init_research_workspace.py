#!/usr/bin/env python3
"""Initialize a downstream .omx/ai-research portfolio workspace.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Initialize .omx/ai-research portfolio files.")
