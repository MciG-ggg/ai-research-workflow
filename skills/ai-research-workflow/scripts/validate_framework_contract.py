...
REQUIRED_PHRASES = {
    "SKILL.md": [
        ...
        "Research Feedback Memory and Researcher Growth Review are disabled by default",
        "`--feedback-memory`",
        "`--growth-review`",
        "`--no-feedback`",
    ...
    "references/artifact-contracts.md": [
        ...
        "Research Feedback Memory and Researcher Growth Review are opt-in",
        "disabled by default",
    ...
    "references/experiment-runtime-standards.md": [
        ...
        "optional Research Feedback Memory or Researcher Growth Review artifact paths",
    ],
    "references/project-local-script-registry.md": [
        "framework-first",
